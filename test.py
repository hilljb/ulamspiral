...
class ExceptionTest(unittest.TestCase):
    ...
    #### UlamSpiral init: start must be an int or long ############################################
    ...
    def test_start_large(self):
        self.assertRaises(ValueError, ulamspiral.UlamSpiral, end=24, start=4294967299)

    #### UlamSpiral init: end must be an int or long ##############################################
    ...
    def test_end_less_than_start(self):
        self.assertRaises(ValueError, ulamspiral.UlamSpiral, end=24, start=100)
...
class EqualityTest(unittest.TestCase):
    ...
    def test_example_less_trivial(self):
        val = [[0, 1]]
        self.failUnlessEqual(ulamspiral.UlamSpiral(1, start=0).rows, val)

    #### UlamSpiral example with start at 1 #######################################################
    def test_example_start_zero(self):
        val = ' 21 22 23 24   \n 20  7  8  9 10\n 19  6  1  2 11\n 18  5  4  3 12\n 17 16 15 14 13\n'
        self.failUnlessEqual(str(ulamspiral.UlamSpiral(24)), val)

    #### UlamSpiral example with start at 0 #######################################################
    def test_example_start_one(self):
        val = ' 20 21 22 23 24\n 19  6  7  8  9\n 18  5  0  1 10\n 17  4  3  2 11\n 16 15 14 13 12\n'
        self.failUnlessEqual(str(ulamspiral.UlamSpiral(24, start=0)), val)
